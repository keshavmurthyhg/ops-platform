...
BASE_PTC_URL   = "https://support.ptc.com/appserver/cs/view/solution.jsp?n="
...
def _slide_incident(prs, data, inc_num):
    ...
    for ri, (lbl1, key1, link1, lbl2, key2, date2) in enumerate(META_ROWS):
        ...
        if link1 and val1 != "-":
            ...
            elif "ptc" in lbl_lower:
                url1 = BASE_PTC_URL + val1
            else:
                url1 = None
        else:
            url1 = None
    ...
    for ri, (lbl, val, acc) in enumerate(RCA_ROWS):
        ...
        # 5pt coloured left accent stripe (thin, not an emoji)
