"""
PPT Converter — Standalone App
================================
Run this file to launch ONLY the Converter module.
...
app = Flask(__name__)
app.secret_key = "converter_app_secret"
...
if __name__ == "__main__":
    print("Running PPT Converter as a Standalone Web Application...")
